...
function hide() {
    for (const link of vid) {
        link.classList.add('hidden');                                                                   //expliquer dans cv.js
           
        }}
function show() {
     for (const link of vid) {
         link.classList.add('visible');                                                                   //expliquer dans cv.js
...
if (confirm("cette page contient des images qui pourraient choquer les personnes sensibles, voulez vous continuer ?")) {
    show()
